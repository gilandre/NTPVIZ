"""
Modèle SystemConfig - Configuration système
"""
import json
...
class SystemConfig(db.Model):
    ...
    def init_default_configs(cls):
        ...
        defaults = [
            ...
            ('ntp.max_offset_warning', 1.0, 'float', 'Seuil d\'alerte pour l\'écart (secondes)', 'ntp'),
            ('ntp.max_offset_critical', 5.0, 'float', 'Seuil critique pour l\'écart (secondes)', 'ntp'),
            
            # Configuration alertes
            ('alerts.retention_days', 30, 'int', 'Durée de conservation des alertes (jours)', 'alerts'),
            ...
            ('network.max_connections', 100, 'int', 'Nombre maximum de connexions simultanées', 'network'),
            ('network.connection_timeout', 30, 'int', 'Timeout de connexion réseau (secondes)', 'network'),
            
            # Configuration monitoring
            ('monitoring.log_retention_days', 7, 'int', 'Durée de conservation des logs (jours)', 'monitoring'),
