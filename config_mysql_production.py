# Configuration MySQL pour NTP Monitor - Production
import os
...
class Config:
    ...
    MYSQL_PORT = 3306
    MYSQL_USER = 'root'
    MYSQL_PASSWORD = ''  # Authentification socket Unix
    ...
    print(f"✅ Configuration MySQL Production: {SQLALCHEMY_DATABASE_URI}")
