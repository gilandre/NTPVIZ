...
VERSION PRODUCTION MYSQL - MISE À JOUR avec utilisateur ntpmonitor
"""
...
class DatabaseManager:
    ...
    def __init__(self):
        ...
        self.logger.info(f"🔌 URL MySQL: mysql+pymysql://{self.mysql_config['user']}@{self.mysql_config['host']}:{self.mysql_config['port']}/{self.mysql_config['database']}")
